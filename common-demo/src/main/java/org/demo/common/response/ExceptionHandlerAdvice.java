...
import org.bh.pro.base.exception.BaseException;
...
public class ExceptionHandlerAdvice {
    ...
    public Result<String> exception(BaseException e) {
        ...
        return Result.build(null, 0, e.getMessage(), e.getCodec());
    }
    ...
    public Result<String> RuntimeException(RuntimeException e) {
        ...
        if(e.getCause() != null && e.getCause() instanceof BaseException){
            return Result.build(null, 0, e.getCause().getMessage(), ((BaseException) e.getCause()).getCodec());
        }
